...
class Assets{
    ...
    public function register_scripts(){
            //Register scripts
            wp_register_script('main-js',TEACHER_DIR_URI.'/assets/main.js',[],filemtime(TEACHER_DIR_PATH.'/assets/main.js'),true);
            wp_register_script('bootstrap-js',TEACHER_DIR_URI.'/assets/src/library/js/bootstrap.min.js',array("jquery"),false,true);
            //Enqueue scripts
